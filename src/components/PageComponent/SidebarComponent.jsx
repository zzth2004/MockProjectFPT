...
export default function Sidebar({ mobile = false }) {
  ...
  const navItems = [
    { icon: <Home size={sizeIcon} />, label: "Dashboard", to: "/dashboard" },
    { icon: <BookOpen size={sizeIcon} />, label: "Course", to: "/course" },
    { icon: <MessageCircle size={sizeIcon} />, label: "Message", to: "/message" },
    { icon: <Calendar size={sizeIcon} />, label: "Schedule", to: "/schedule" },
    { icon: <User size={sizeIcon} />, label: "Account", to: "/account" },
  ];
  ...
  const renderLink = (item) => {
    ...
    return (
      <Link
        ...
        className={`flex items-center gap-3 px-4 py-3 mb-2 transition duration-200 ${
          isActive
            ? "bg-white text-black"
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="px-2 py-2 flex items-center gap-4 shadow-lg rounded-b-xl mt-2.5 mb-1.5"
