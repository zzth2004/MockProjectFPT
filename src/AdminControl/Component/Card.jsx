export const KLCard = ({ title, subtitle, children, action, className = "" }) => (
  <div className={`bg-white rounded-[2rem] border-2 border-gray-100 shadow-xl overflow-hidden ${className}`}>
    {(title || action) && (
