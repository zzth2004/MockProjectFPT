...
const courseClassService = {
  ...
  getAllClasses: async (page = 1, limit = 100, search = "", status = "") => {
    return axiosClient.get("/course-classes/class", { 
  ...
  getClassesByCourse: async (courseId) => {
    return axiosClient.get(`/course-classes/course/${courseId}/class`).then(res => {
      return res.data.data;
    });
  },
  ...
  createClass: async (classData) => {
    return axiosClient.post("/course-classes/class/new", classData).then(res => {
      return res.data.data;
    });
  },
  ...
  updateClass: async (id, updateData) => {
    return axiosClient.patch(`/course-classes/class/${id}/update`, updateData).then(res => {
      return res.data.data;
    });
  },
  ...
  deleteClass: async (id) => {
    return axiosClient.delete(`/course-classes/class/${id}/delete`).then(res => {
      return res.data.data;
    });
  }
};
