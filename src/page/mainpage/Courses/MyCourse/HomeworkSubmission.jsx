  ...
  return (
    <div className="w-full min-h-screen font-sans pt-2 pb-8 bg-[#F5F7FA] px-4 md:px-0">
       ...
       <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-8">
          ...
          <span className="bg-[#EAD4B6] text-[#856404] px-4 py-1.5 rounded-md border border-[#c4a172] text-xs font-bold uppercase tracking-wider self-start md:mt-2">
             {assignment.status}
          </span>
       </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
             <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200">
                ...
                <div className="mb-8">
                   ...
                   <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:bg-gray-50 hover:border-[#377437] transition-all cursor-pointer group bg-white">
                      <div className="w-12 h-12 bg-green-50 text-[#377437] rounded-full flex items-center justify-center mb-3">
                         <Upload size={24} />
                      </div>
                ...
                {/* Nút Nộp */}
                <button className="w-full bg-[#377437] hover:bg-green-800 text-white font-bold py-3.5 rounded-xl transition-colors">
                   Submit Assignment
                </button>
